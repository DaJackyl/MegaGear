...
import com.megathirio.megagear.engine.core.Util;
import com.megathirio.megagear.engine.core.Vector3f;
...
public class Shader
{
    ...
    private static String loadShader(String fileName)
    {
        ...
        try
        {
            shaderReader = new BufferedReader(new FileReader("./assets/shaders/" + fileName));
            String line;
